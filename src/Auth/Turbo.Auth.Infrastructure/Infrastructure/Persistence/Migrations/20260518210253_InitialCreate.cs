        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    oauth_refresh_token = table.Column<string>(type: "character varying(1024)", maxLength: 1024, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_authentication_methods_accounts_account_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_authentication_methods_account_id_provider_name",
                table: "authentication_methods",
                columns: new[] { "account_id", "provider_name" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_authentication_methods_provider_name_external_user_id",
                table: "authentication_methods",
                columns: new[] { "provider_name", "external_user_id" },
                unique: true,
                filter: "\"external_user_id\" IS NOT NULL");
