...
fn main() {
    ...
    if std::env::var("CLOUD_SAMPLES").is_ok() {
        ...
        let looks: [(&str, f32, f32, f32, f32, f32, f32); 9] = [
            ...
            ("02_fine_detail", 12.0, 0.35, 16.0, 15.0, 0.4, 1.0),
            ("03_very_fine", 16.0, 0.35, 17.0, 16.0, 0.4, 1.0),
            ("04_low_sun_shadow", 8.0, 0.18, 15.0, 18.0, 0.45, 1.0),
            ("05_high_sun", 8.0, 0.7, 14.0, 11.0, 0.5, 1.0),
            ("06_thin_wispy", 9.0, 0.35, 8.0, 13.0, 0.5, 0.9),
            ("07_dense", 8.0, 0.3, 20.0, 16.0, 0.4, 1.0),
            ("08_deep_shadow", 9.0, 0.22, 17.0, 22.0, 0.4, 1.0),
            ("09_soft_lit", 8.0, 0.5, 13.0, 12.0, 0.5, 1.0),
        ];
