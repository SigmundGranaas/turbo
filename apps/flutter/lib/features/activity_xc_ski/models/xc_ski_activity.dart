...
class XcSkiActivity {
  ...
  factory XcSkiActivity.fromJson(Map<String, dynamic> json) {
    ...
    return XcSkiActivity(
      ...
      details: XcSkiDetails.fromJson(json['details'] as Map<String, dynamic>),
