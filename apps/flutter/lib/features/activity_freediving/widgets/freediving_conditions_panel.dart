...
class FreedivingConditionsPanel extends ConsumerWidget {
  final String activityId;
  const FreedivingConditionsPanel({super.key, required this.activityId});
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
          Row(children: [
            const Icon(Icons.scuba_diving_outlined, size: 20),
            ...
            IconButton(
              ...
              tooltip: 'Refresh',
              onPressed: () => ref.invalidate(freedivingConditionsProvider(activityId)),
            ),
          ]),
...
class _Body extends StatelessWidget {
  final FreedivingConditionsReport report;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      if (report.seaStateSummary != null && report.seaStateSummary!.isNotEmpty)
        Container(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 8),
            Expanded(child: Text('Sea state: ${report.seaStateSummary}',
