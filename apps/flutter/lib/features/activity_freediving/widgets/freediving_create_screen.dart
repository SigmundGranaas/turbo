...
class _FreedivingCreateScreenState extends ConsumerState<FreedivingCreateScreen> {
  ...
  Widget build(BuildContext context) {
    return ActivityCreateScaffold(
      title: _isEdit ? 'Edit freediving spot' : 'New freediving spot',
      formKey: _formKey,
      ...
      fields: [
        ...
        const SizedBox(height: 12),
        Row(children: [
          Expanded(child: ActivityCreateScaffold.numberField(_depth, 'Max depth m')),
          const SizedBox(width: 8),
          Expanded(child: ActivityCreateScaffold.numberField(_visibility, 'Visibility m', required: false)),
        ]),
